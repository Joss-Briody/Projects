...
class DQNagent():
	...
	def Build_Qlearning_graph(self, target_agent):
		...
		# use the target network to make the target predictions
...
def training_episode_with_replay_target(agent, target_agent, epsilon, env, sess, state):
...
def run_Q_learning():
	...
	with tf.Session() as sess:
		...
		for e in range(n_episodes):	
			...
			t, loss = training_episode_with_replay_target(agent, target_agent, epsilon, env, sess, state)
